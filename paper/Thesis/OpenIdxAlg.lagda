...
\section{Open Indexed Types}\label{sec:idxalg}
...
\subsection{Categorical Model}\label{sec:idxalgsem}
...
\subsection{Formal Model}\label{sec:idxalgmod}
...
\subsection{Examples}\label{sec:idxalgtps}
