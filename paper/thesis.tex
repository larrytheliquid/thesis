...
logical correctness criteria into the very definitions of
...
in dependently typed language. Our solution is to write generic
...
defined in the \textit{future}. Our solution builds upon a mountain of
...
the programming language. Historically, there has been a tradeoff
between the expressivity of the modeled programming language, and the
types of generic functions that could be written in it. Our
dissertation shows that no such tradeoff is necessary, and that we can
