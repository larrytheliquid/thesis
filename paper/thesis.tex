...
\newcommand{\Title}{Concrete Generic Programming}
...
\chapter{Universes \& Generic Programming}\label{ch:univ}
...
\part{Open Inductive Types}\label{part:open}

\chapter{Open Inductive Universes}\label{ch:open}
...
\part{Closed Inductive Types}\label{part:closed}
...
\part{Closed Hierarchy of Types}\label{part:hier}
