...
\chapter{Overview}\label{ch:open}
...
In this \textbf{part} we present an adequate alternative to modeling
...
This \textbf{part} defines the initial algebra semantics for a series
...
\refpart{closed} adapts the formal model of
inductive-recursive types as an \textit{open} universe
(\refchap{iralg})
to a \textit{closed} universe (\refpart{closed}),
...
\part{Closed Algebraic Universe}\label{part:closed}
\chapter{Overview}

This \textbf{part} will be an adaption of my paper on
...
\chapter{Closed Inductive-Recursive Types}\label{ch:closed}

\chapter{Fully Generic Count}
\chapter{Fully Generic AST}
\chapter{Fully Generic Lookup}
\chapter{Fully Generic Update}
\chapter{Higher-Order Fully Generic AST}
...
\chapter{Closed Hierarchy of Well-Order Types}\label{ch:hierw}
\chapter{Closed Hierarchy of Inductive-Recursive Types}\label{ch:hierir}
\chapter{Higher-Order Fully Generic AST}\label{ch:gasts}
