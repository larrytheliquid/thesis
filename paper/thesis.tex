...
\newcommand{\Title}{Towards Concrete Generic Programming}
...
\chapter{Concrete Generic Programming}\label{ch:univ}
\include{Thesis/GenericW}
\include{Thesis/ClosedW}
\section{Concrete Programming}

\part{Open Inductive Universes}\label{part:open}

\chapter{Open Inductive Types}\label{ch:open}
...
%% Closed Universe of Inductive Types
\part{Closed Inductive Universes}\label{part:closed}
...
\chapter{Closed Inductive Types}\label{ch:closed}
...
%% Closed Hierarchy of Universes of Inductive Types
